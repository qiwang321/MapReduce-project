...
public class GlobalUtil1{
    public static final int ITERATIONS = 5;  
    public static int NUM_LAYER = 4;
    public static int NODES_INPUT = 27*27*3;
    ...
    public static final int[] nodes_layer = {GlobalUtil1.NODES_INPUT, 1000, 500, 250, 2};
