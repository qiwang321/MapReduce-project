...
public class largeSample extends Configured implements Tool {
  ...
  private static class MyMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
    ...
    private final static IntWritable TARGET = new IntWritable();
    private static float lambda; // parameter for poisson distribution
    private static PoissonGenerator rg; // poisson random number generator
    private static int m, n, km, t;
    ...
    public void setup(Context context) {
    	...
    	rg = new PoissonGenerator(lambda, new Random());
    }
    @Override
  ...
  private static class MyReducer extends Reducer<IntWritable, Text, NullWritable, Text> {
